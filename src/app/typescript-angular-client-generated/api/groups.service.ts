...
export class GroupsService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public getGroups(page?: number, size?: number, observe?: 'body', reportProgress?: boolean): Observable<HyGroups>;
    public getGroups(page?: number, size?: number, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<HyGroups>>;
    public getGroups(page?: number, size?: number, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<HyGroups>>;
    public getGroups(page?: number, size?: number, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
