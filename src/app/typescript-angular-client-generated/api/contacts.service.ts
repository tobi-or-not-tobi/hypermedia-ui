...
export class ContactsService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public getContacts(page?: number, size?: number, observe?: 'body', reportProgress?: boolean): Observable<HyContacts>;
    public getContacts(page?: number, size?: number, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<HyContacts>>;
    public getContacts(page?: number, size?: number, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<HyContacts>>;
    public getContacts(page?: number, size?: number, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
